...
5. Authenticate your Azure CLI (`az login`) or configure your service principal credentials. For the Azure role assignments required per feature, see [Azure Service Principal](#azure-service-principal).
