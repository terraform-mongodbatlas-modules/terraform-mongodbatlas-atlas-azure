...
**Validation rules:**
1. Type in [allowed-types.txt](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/changelog/allowed-types.txt), prefix in [allowed-prefixes.txt](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/changelog/allowed-prefixes.txt).
...
- [`tools/changelog/allowed-types.txt`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/changelog/allowed-types.txt) - Valid types.
- [`tools/changelog/allowed-prefixes.txt`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/changelog/allowed-prefixes.txt) - Valid prefixes.
- [`tools/changelog/check-changelog-entry-file/main.go`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/changelog/check-changelog-entry-file/main.go) - Validation script.
- [`.github/workflows/check-changelog-entry-file.yml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/.github/workflows/check-changelog-entry-file.yml) - Validation GitHub Action.
- [`.github/workflows/generate-changelog.yml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/.github/workflows/generate-changelog.yml) - Generate Changelog GitHub Action.
