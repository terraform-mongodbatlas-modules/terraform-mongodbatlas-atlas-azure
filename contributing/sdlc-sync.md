...
The cluster module defines shared tooling in [`.github/sdlc.src.yaml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/.github/sdlc.src.yaml). The `path-sync` tool copies files one-way from cluster to destination modules.
