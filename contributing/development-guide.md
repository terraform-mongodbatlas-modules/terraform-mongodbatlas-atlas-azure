# Contributing to terraform-mongodbatlas-atlas-azure
...
# Clone and setup
git clone <repo-url>
cd terraform-mongodbatlas-atlas-azure
...
See [test-guide.md](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/contributing/test-guide.md) for detailed testing documentation including:
