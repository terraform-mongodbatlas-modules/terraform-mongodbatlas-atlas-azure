...
Most of this tree is copied from the [cluster module](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-cluster) via [path-sync](https://github.com/EspenAlbert/path-sync). See the [SDLC Sync Guide](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/contributing/sdlc-sync.md) for how sync works, what is included, and how to request changes.
...
- Or the path is listed in [`.github/sdlc.src.yaml`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/.github/sdlc.src.yaml).
...
`tools/tf_gen/` exists only in the cluster repository and is not part of SDLC sync. See [tools/tf_gen/README.md](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-atlas-azure/blob/v0.3.1/tools/tf_gen/README.md).
